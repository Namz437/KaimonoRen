 ...
 */
mongoose.connect("mongodb://localhost:27017/db_hijab", {
...
// Mengambil fungsi yang route hijab
const hijabRouter = require("./routes/hijab");
...
// untuk home
app.get("/kaimono", (req, res) => {
  res.render("kaimono", { title: "Home Page" });
});
...
// Menggunakan routes hijab
app.use("/hijab", hijabRouter);
